...
#
# can't remember who wrote this but it wasn't me -- need to track down who did

source "${HOME}/.config/sketchybar/plugins/secrets.sh"

WEATHER_API_KEY=${WEATHER_API_KEY} # insert api key here
CITY=${CITY} # insert city here
